...
namespace DevPioneers.Persistence.Migrations
{
    ...
    [Migration("20251019210051_AddOtpCodeEntity")]
            ...
            modelBuilder.Entity("DevPioneers.Domain.Entities.OtpCode", b =>
                {
                    ...
                    b.ToTable("OtpCodes", null, t =>
                        {
                            t.HasCheckConstraint("CK_OtpCodes_EmailOrMobile", "([Email] IS NOT NULL) OR ([Mobile] IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("DevPioneers.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAtUtc = new DateTime(2025, 10, 19, 21, 0, 47, 57, DateTimeKind.Utc).AddTicks(2741),
                        ...
                        {
                            Id = 2,
                            CreatedAtUtc = new DateTime(2025, 10, 19, 21, 0, 47, 57, DateTimeKind.Utc).AddTicks(3009),
                        ...
                        {
                            Id = 3,
                            CreatedAtUtc = new DateTime(2025, 10, 19, 21, 0, 47, 57, DateTimeKind.Utc).AddTicks(3029),
            ...
            modelBuilder.Entity("DevPioneers.Domain.Entities.SubscriptionPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAtUtc = new DateTime(2025, 10, 19, 21, 0, 47, 62, DateTimeKind.Utc).AddTicks(7508),
                            Currency = "EGP",
                        ...
                        new
                        {
                            Id = 2,
                            BillingCycle = "Monthly",
                            CreatedAtUtc = new DateTime(2025, 10, 19, 21, 0, 47, 62, DateTimeKind.Utc).AddTicks(7520),
                            Currency = "EGP",
                        ...
                        new
                        {
                            Id = 3,
                            BillingCycle = "Monthly",
                            CreatedAtUtc = new DateTime(2025, 10, 19, 21, 0, 47, 62, DateTimeKind.Utc).AddTicks(7524),
                            Currency = "EGP",
            ...
            modelBuilder.Entity("DevPioneers.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<string>("MobileVerificationToken")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("MobileVerificationTokenExpiresAt")
                        .HasColumnType("datetime2");
