        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountPercentage = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false, defaultValue: 0m),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MobileVerified = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AutoRenewal = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransferToUserId = table.Column<int>(type: "int", nullable: true),
                    Metadata = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "CreatedAtUtc", "DeletedAtUtc", "Description", "IsDeleted", "IsSystemRole", "Name", "NormalizedName", "UpdatedAtUtc" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 10, 16, 13, 37, 53, 15, DateTimeKind.Utc).AddTicks(1816), null, "System Administrator with full access", false, true, "Admin", "ADMIN", null },
                    { 2, new DateTime(2025, 10, 16, 13, 37, 53, 15, DateTimeKind.Utc).AddTicks(2085), null, "Manager with elevated permissions", false, true, "Manager", "MANAGER", null },
                    { 3, new DateTime(2025, 10, 16, 13, 37, 53, 15, DateTimeKind.Utc).AddTicks(2087), null, "Regular user with standard access", false, true, "User", "USER", null }
                });

            migrationBuilder.InsertData(
                table: "SubscriptionPlans",
                columns: new[] { "Id", "BillingCycle", "CreatedAtUtc", "CreatedById", "Currency", "DeletedAtUtc", "DeletedById", "Description", "DisplayOrder", "Features", "IsActive", "IsDeleted", "MaxStorageGb", "MaxUsers", "Name", "PointsAwarded", "Price", "TrialDurationDays", "UpdatedAtUtc", "UpdatedById" },
                values: new object[,]
                {
                    { 1, "Monthly", new DateTime(2025, 10, 16, 13, 37, 53, 21, DateTimeKind.Utc).AddTicks(387), null, "EGP", null, null, "Perfect for individuals and small projects", 1, "[\"1 User\",\"10 GB Storage\",\"Email Support\"]", true, false, 10, 1, "Basic", 100, 99.00m, 7, null, null },
                    { 2, "Monthly", new DateTime(2025, 10, 16, 13, 37, 53, 21, DateTimeKind.Utc).AddTicks(397), null, "EGP", null, null, "For growing teams and businesses", 2, "[\"5 Users\",\"50 GB Storage\",\"Priority Support\",\"Advanced Analytics\"]", true, false, 50, 5, "Professional", 500, 299.00m, 14, null, null },
                    { 3, "Monthly", new DateTime(2025, 10, 16, 13, 37, 53, 21, DateTimeKind.Utc).AddTicks(400), null, "EGP", null, null, "For large organizations with advanced needs", 3, "[\"Unlimited Users\",\"Unlimited Storage\",\"24/7 Support\",\"Custom Integration\",\"Dedicated Account Manager\"]", true, false, -1, -1, "Enterprise", 2000, 999.00m, 30, null, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_Revoked_Expired",
                table: "RefreshTokens",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionPlans_Active_Order",
                table: "SubscriptionPlans",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WalletTransactions_TransferToUserId",
                table: "WalletTransactions",
                column: "TransferToUserId",
                filter: "[TransferToUserId] IS NOT NULL");
